    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center gap-2 mb-2">
          <h1 className="text-2xl font-bold text-text-primary">Funding & Program Readiness</h1>
          <span className="text-[10px] px-2 py-0.5 rounded bg-primary/10 text-primary font-medium">
            Incubation & Grant Readiness
          </span>
        </div>
      ...
      <Card>
        <CardHeader>
          <h3 className="text-sm font-semibold text-text-primary">6. Why BuildMe Needs an Incubation Program</h3>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <h3 className="text-sm font-semibold text-text-primary">7. 12-Month Development Path</h3>
        </CardHeader>
        <CardContent>
          <div className="flex items-center gap-2 overflow-x-auto py-2">
            {[
          ...
          <div className="mt-3 p-3 rounded bg-primary/5 border border-primary/20">
            <p className="text-xs text-text-primary font-medium">
              The next 12 months enable the critical transition from working prototype to validated intelligence product.
            </p>
            <p className="text-[10px] text-text-secondary mt-1">
              Without real pilot data, BuildMe cannot validate whether its intelligence engine actually helps engineers.
              An incubation or grant program provides the infrastructure, mentorship, and network to execute this validation.
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <h3 className="text-sm font-semibold text-text-primary">8. Program Readiness Assessment</h3>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            {[
              ...
              { criterion: "Technical roadmap", status: "ready" as const, detail: "12-month roadmap defined" },
              { criterion: "Growth potential", status: "ready" as const, detail: "Clear path from prototype → dataset → ML" },
      ...
      <div className="flex items-center gap-3">
        ...
        <Link href="/engineer/roadmap" className="text-sm font-medium text-primary hover:underline flex items-center gap-1">
          Product Roadmap <ArrowRight className="h-3 w-3" />
        </Link>
      </div>
    </div>
  );
